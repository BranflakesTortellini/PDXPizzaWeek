...
def extract_info_from_description(description, url):
    ...
    # Handle the vegan and vegetarian options based on the meat_or_veggie field
    if 'Vegetarian' in info['meat_or_veggie']:
        info['vegetarian_available'] = 'Yes'
        info['vegetarian_substitute'] = 'Yes'
    else:
        info['vegetarian_available'] = 'No'

    if 'Vegan' in info['meat_or_veggie']:
        info['vegan_available'] = 'Yes'
        info['vegan_substitute'] = 'Yes'
        info['vegetarian_available'] = 'No'
        info['vegetarian_substitute'] = 'No'
    else:
        info['vegan_available'] = 'No'

    #If the item is marked as vegetarian or vegan, we assume it's available, hence no 'Unknown'
    if 'Yes' in info['vegetarian_substitute'] and 'Meat' in info['meat_or_veggie']:
        info['meat_or_veggie'] = 'Meat, Vegetarian'
 
    if 'Yes' in info['vegan_substitute'] and 'Meat' in info['meat_or_veggie']:
        info['meat_or_veggie'] = 'Meat, Vegan'

    if 'Yes' in info['vegan_substitute'] and 'Meat' in info['meat_or_veggie'] and 'Yes' in info['vegetarian_substitute']:
        info['meat_or_veggie'] = 'Meat, Vegetarian, Vegan'
    
    if 'Yes' in info['vegan_substitute'] and 'Yes' in info['vegetarian_substitute']:
        info['meat_or_veggie'] = 'Vegetarian, Vegan'
...
def rename_and_reorder_columns(df):
    ...
    new_column_names = {
        'name': 'Pizza Name',
        'location_time': 'Available Time',
        'meat_or_veggie': 'Type',
        'vegetarian_substitute': 'Vegetarian Option',
        'vegan_substitute': 'Vegan Option',
